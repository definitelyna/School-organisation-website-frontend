...
const sidebarOptions = ["Dashboard", "Timetable", "Tasks", "Events"];
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="fixed" open={open}>
          <Toolbar>
            ...
            <div style={{margin: "auto", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
